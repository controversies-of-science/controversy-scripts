...
sigV4Client.newClient = function (config) {
	...
	awsSigV4Client.signRequest = function (request) {
		...
		var path = awsSigV4Client.pathComponent + request.path;
		var queryParams = _extends({}, request.queryParams);
		...
		var body = _extends({}, request.body);
		...
		var parser = new _whatwgUrl.URL(awsSigV4Client.endpoint);
